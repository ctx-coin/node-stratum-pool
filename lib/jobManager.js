...
var JobManager = module.exports = function JobManager(options){
    ...
    this.updateCurrentJob = function(rpcData){
		...
		/* CTX */
		if (rpcData.acceptancepointsvalue && options.coin.acceptancepointsScript) {
            rpcData.acceptancepointsScript = options.coin.acceptancepointsScript;
        }
		
		if (rpcData.poscoachesvalue && options.coin.poscoachesScript) {
            rpcData.poscoachesScript = options.coin.poscoachesScript;
        }
		
		if (rpcData.devmarketingvalue && options.coin.devmarketingScript) {
            rpcData.devmarketingScript = options.coin.devmarketingScript;
        }
