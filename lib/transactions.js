...
var generateOutputTransactions = function(poolRecipient, recipients, rpcData){
	...
	/* CTX */
if (rpcData.devmarketingvalue && options.coin.devmarketingScript) {
    reward -= rpcData.devmarketingvalue;
	rewardToPool -= rpcData.devmarketingvalue;
}

if (rpcData.acceptancepoints && options.coin.acceptancepointsScript) {
    reward -= rpcData.acceptancepoints;
	rewardToPool -= rpcData.acceptancepoints;
}
		
if (rpcData.poscoachesvalue && options.coin.poscoachesScript) {
...
if (rpcData.payee) {
	...
	if (rpcData.acceptancepoints && options.coin.acceptancepointsScript) {
        ...
        txOutputBuffers.unshift(Buffer.concat([
            util.packInt64LE(rpcData.acceptancepoints),
